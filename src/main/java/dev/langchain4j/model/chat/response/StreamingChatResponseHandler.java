...
public interface StreamingChatResponseHandler {
    ...
    /**
     * Invoked each time the model generates a partial response (usually a single
     * token) in a textual response.
     * If the model decides to execute a tool instead, this method will not be
     * invoked;
     * {@link #onCompleteResponse} will be invoked instead.
     *
     * @param partialResponse The partial response (usually a single token), which
     *                        is a part of the complete response.
     */
    ...
    /**
     * TODO
     * TODO this callback is called as soon as a single tool execution request is
     * complete
     * TODO can be called multiple times
     * 
     * @param index                        TODO
     ...
     * this can be accessed via {@link ChatResponse#aiMessage()} ->
     * {@link AiMessage#toolExecutionRequests()}.
     *
     * @param completeResponse The complete response generated by the model.
     *                         For textual responses, it contains all tokens from
     *                         {@link #onPartialResponse} concatenated.
     */
