...
import com.ZeroStack.model.enums.UserRoleEnum;
...
import com.ZeroStack.mapper.UserMapper;
...
import static com.ZeroStack.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>  implements UserService{
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        user.setUserName("用户" + userAccount.substring(0, 3) + Math.round(Math.random() * 1000));
